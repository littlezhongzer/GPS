...
public final class FileIoUtils {
    ...
    public File makeFilePath(String filePath,String mkName1,String mkName2,String fileName) {
        File file0 = null;
        file0 = new File(filePath+mkName1);
        if (!file0.exists()) {
            file0.mkdir();
        }
        File file1 = null;
        file1 = new File(filePath+mkName2);
        if (!file1.exists()) {
            file1.mkdir();
        }
        File file2=null;
        try {
            file2 = new File(filePath+mkName1+mkName2,fileName);
            if (!file2.exists()) {
                file2.createNewFile();
            }
        } catch (Exception e) {
