...
import static com.example.quectel.quectel_gps.MainActivity.flag_warm;

public class GPS_warm extends AppCompatActivity {
    private LocationManager locationManager;
    private String locationProvider;
    public final  String TAG="gps warm";
    ...
    public static int warm=0; // 1 to listener alive,2 to listener die
    ...
    String mkName1="GPS/";
    String mkName2="Warm/";
    String private_filename="Warm_test.txt"; //test statistics

    String fileName_nema;
    String private_filename_nema="Warm_nema.txt"; //nema statistics
    ...
    protected void onCreate(Bundle savedInstanceState)  {
        ...
        setContentView(R.layout.activity_gps_warm);
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            if (ActivityCompat.checkSelfPermission(GPS_warm.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(GPS_warm.this, PERMISSIONS_STORAGE, REQUEST_PERMISSION_CODE);
     ...
     //   }
        ...
        GPS_warm_Thread warm_thread = new GPS_warm_Thread();
        warm_thread.start();
    ...
    private void showLocation(Location location) {
        if(!flag_send_msg_listener){
            ...
            Log.d(TAG, "showLocation: sumtime"+sum_time);
   ...
   public class GPS_warm_Thread extends Thread{
        public void run(){
            ...
            while (true){
                if(flag_warm){
                    ...
                    bundle.putBoolean("ephemeris",false);
                    ...
                    Log.d(TAG, "run:all provide gps command"+   locationManager.sendExtraCommand("gps", "force_time_injection", bundle));
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0x2000) {
                if(!flag_addlistener&&flag_warm){
                    locationManager.requestLocationUpdates(locationProvider, 0, 50, locationListener);
                    locationManager.addGpsStatusListener(gpsStatusListener);
                    ...
                    locationManager.removeNmeaListener(mNmeaListener);
                    locationManager.removeGpsStatusListener(gpsStatusListener);
                    Log.d(TAG, "handleMessage: already listenerddddddddddddddddddddddddddddddddddddd");
                }
            ...
            if (msg.what == 0x2001) {
                ...
                mFileutil.result_append(SD_path+mkName1+mkName2+fileName,mFileutil.getDate()+"\t"+"*GPS Warm Boot Up*"+"\t"+times_st+"\t"+diff_time_st+" ms"+"\t"+Longitude+"#"+Latitude+"\t"+count+"\t"+"PASS"+"\t\n");
            ...
            if(msg.what==0x2004){
                ...
                mFileutil.result_append(SD_path+mkName1+mkName2+fileName,mFileutil.getDate()+"\t"+"*GPS Warm Boot Up*"+"\t"+times_st+"\t"+"180000 ms"+"\t"+"fail"+"#"+"fail"+"\t"+count+"\t"+"Time Out:Exceeded 180s"+"\t\n");
                flag_addlistener=false;
            ...
            if(msg.what==0x2005){
                if(i==0){
                    ...
                    flag_addlistener=false;
                    Toast.makeText(GPS_warm.this,"数据统计成功，请按返回键退出",Toast.LENGTH_SHORT).show();
                }
            }
        }
    };
    ...
    public void exit() {
        if ((System.currentTimeMillis() - mExitTime) > 2000) {
            View view;
            AlertDialog.Builder builder= new AlertDialog.Builder(GPS_warm.this);
            view= LayoutInflater.from(GPS_warm.this).inflate(R.layout.dialog, null);
